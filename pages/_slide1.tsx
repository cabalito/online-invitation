...
const Slide1 = () => {
  return (
    <div className="h-full w-full">
      ...
      />
      <div>
      <div className="px-4 py-4 lg:px-16 lg:py-8 h-2/3 md:flex md:justify-center md:items-center">
        <Countdown />
      </div>
      <div className="px-6 py-4 lg:px-16 lg:py-5 h-2/3 md:flex md:justify-center md:items-center">
