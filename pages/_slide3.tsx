  ...
  <div className="h-full w-full p-4 lg:px-16 lg:py-16 bg-gray-000">
    ...
    <div className="h-full grid grid-cols-1 lg:grid-cols-3 lg:h-1/3">
      <div className="h-full lg:col-span-2">
        <div className="items-center justify-center h-full lg:h-full w-full">
          <h3 className="text-gray-800 text-3xl sm:text-5xl lg:text-xl lg:text-5xl font-extrabold font-serif">
            Acceso en coche
          </h3>

          <p className="text-gray-800 text-md text-white font-sans mt-2 mb-5">
            ...
            <ol className=" mt-2 mb-10">
              <li>1. Aparcar en el parking gratuito de la estación de autobuses <a className="text-blue-600" href="https://goo.gl/maps/CuxzPUwTAKeAvX1JA">(Cómo llegar)</a> y subir utilizando las escaleras mecánicas. Al salir de misa podreis utilizar el servicio de autobuses.</li>
