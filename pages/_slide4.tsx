  ...
  return (
    <div className="h-full w-full">
      <div className="h-full grid grid-rows-5 sm:grid-rows-1 sm:grid-cols-2">
        <div className="flex flex-1 flex-col justify-between row-span-3 sm:row-span-1 sm:p-4 lg:px-16 lg:py-16">
          <article className="px-4 pt-5 sm:p-0 space-y-4 sm:max-w-prose mb-2 sm:mb-8">
            ...
            <p className="text-md text-gray-600 font-sans">
              ...
              Viñedos Cigarral Santa María. No solo su privilegiada situación convierte este lugar
              en un contexto especial, también su historia. Cuentan que fue este el punto elegido
              por Carlos V para controlar la capital de su creciente imperio y, a su vez, con la
              plantación de las primeras cepas en el año 1997, también pasó a convertirse en uno de los
              cuatro viñedos urbanos únicos en el mundo. Es un lugar mágico que nos ha encantado
              para seguir disfrutando con vosotros para celebrar nuestro enlace.
            </p>
            <p className="text-md text-gray-600 font-sans">
        ...
        <div className="h-full relative row-start-1 row-end-3 sm:row-span-1">
          <Image
            src="/cigarral.jpg"
            layout="fill"
            objectFit="cover"
